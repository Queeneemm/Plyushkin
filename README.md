...
## Основной UX
- `/start` — главное меню.
- `Начать инвентарку / Продолжить инвентарку`
- `Внести позицию` → поиск → выбор → количество
- `Показать внесённые` → изменить/удалить
- `Завершить инвентарку` → загрузить CRM xlsx → отчёт в Google Sheets
- `История инвентарок`
- `Управление пулом`
- `Доступы` (только admin)
- `Отправить сводку`
